...
```bash
vela def apply-module github.com/myorg/kubecon-demo
```

### List definitions

```bash
vela def list-module github.com/myorg/kubecon-demo
```

### Validate definitions

```bash
vela def validate-module github.com/myorg/kubecon-demo
```

### Apply with namespace

```bash
vela def apply-module github.com/myorg/kubecon-demo --namespace my-namespace
```

### Dry-run (preview without applying)

```bash
vela def apply-module github.com/myorg/kubecon-demo --dry-run
```
